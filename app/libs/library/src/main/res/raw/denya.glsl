...
void main()
{
	...
	textureColor = (textureColor2 - textureColor) * 0.0 + textureColor;
    ...
    /*if (base.r < 0.5)
	{
		ra = overlay.r * base.r * 0.0;
	}
	else
	{
		ra = 1.0 - ((1.0 - base.r) * (1.0 - overlay.r) * 0.0);
	}*/

	mediump float ga;
	/*if (base.g < 0.5)
	{
		ga = overlay.g * base.g * 0.0;
	}
	else
	{
		ga = 1.0 - ((1.0 - base.g) * (1.0 - overlay.g) * 0.0);
	}*/

    mediump float ba;
	/*if (base.b < 0.5)
	{
		ba = overlay.b * base.b * 0.0;
	}
	else
	{
	...
	base = (textureColor - base) * (grey1Color.r/0.5) + base;
